"""
Django settings for marsdust project.
...
SECRET_KEY = 'django-insecure-v@omslq#@=oou8w(birb*vu&z=yl5fldc-4p*5uon)v7coszx5'
...
WSGI_APPLICATION = 'marsdust.wsgi.application'
